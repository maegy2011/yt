...
import { Play, Pause, RotateCcw, Plus, Trash2, Save, Bookmark, Edit, Clock, MessageSquare, User, Eye } from 'lucide-react'
...
export function VideoNote({ videoId, videoTitle, channelName, viewCount, publishedAt, thumbnail }: VideoNoteProps) {
  ...
  const toggleFavorite = async () => {
    ...
    addNotification('Favorite', isFavorited ? 'Added to favorites' : 'Removed from favorites', 'info')
  }
